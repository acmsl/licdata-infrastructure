"""
org/acmsl/licdata/infrastructure/licenses/aws_lambda/delete.py
...
import org.acmsl.licdata.infrastructure.licenses.aws_lambdacommon
...
def handler(event, context) -> Dict:
    ...
    :rtype: Dict
    """
    return rest.delete(event, context, Ports.instance().resolve_first(LicenseRepo))
