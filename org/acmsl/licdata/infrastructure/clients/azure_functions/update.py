...
"""
org/acmsl/licdata/infrastructure/azure/clients/update.py

This file defines the Update-Client script for Azure.
...
@bp.function_name(name="UpdateClient")
@bp.route(route="clients/{id}", methods=["POST"], auth_level=func.AuthLevel.ANONYMOUS)
async def update_client(
    req: func.HttpRequest, context: func.Context
) -> func.HttpResponse:
    """
    Azure Function to update a client.
    ...
    from org.acmsl.licdata.events.infrastructure.http.clients import (
        ...
        HttpUpdateClientRequested,
    )

    event = HttpUpdateClientRequested(
    ...
    outcome = HttpClientResponseFactory.instance().from_update_client_requested(
